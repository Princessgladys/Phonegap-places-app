...
$('#page-map').live("pageinit", function() {
    ...
    $('<div class="ui-overlay-shadow ui-body-e ui-corner-all mds-popup" id="intro">' +
            '<h1 style="color:#326f9a;">Googlemaps Places Demo</h1><h4>Google Maps: Markers, Geocoding and jQuery Google Maps Plugin</h4><ul>' +
    ...
    var defaultLoc = new google.maps.LatLng(-1.254844, 36.587454);
